...
public class PracticeMode extends AppCompatActivity implements
...
//        model.select();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PracticeMode.this, LandingActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void loadModels() {
        WeakReference<PracticeMode> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                ...
                .build()
                .thenAccept(model -> {
                    PracticeMode activity = weakActivity.get();
                    if (activity != null) {
        ...
        ModelRenderable.builder()
                .setSource(this, Uri.parse("file:///android_asset/larry.glb")) // Update this line
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
